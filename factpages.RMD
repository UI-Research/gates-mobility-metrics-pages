...
m_info_lst <- get_vars_info('Income')$info_lst
...
m_info_lst <- get_vars_info('Affordable housing')$info_lst
...
m_info_lst <- get_vars_info('Family structure and stability')$info_lst
...
```{r Descriptive representation among local officials}
...
create_tb(m_info_lst, data, trans_cost_varlist) 
...
create_tb_level2(m_info_lst, data, trans_cost_varlist) 
...
m_info_lst <- get_vars_info('Exposure to crime')$info_lst

create_tb(m_info_lst, data, exp_crime_varlist) 
...
create_tb_level2(m_info_lst, data, exp_crime_varlist) 
...
m_info_lst <- get_vars_info('Access to Preschool')$info_lst

create_tb(m_info_lst, data, share_in_presch_varlist) 
...
create_tb_level2(m_info_lst, data, share_in_presch_varlist) 
...
eff_pub_ed <- list(
  ...
  c(
    ...
    'change in ELA achievement ci')
)


m_info_lst <- get_vars_info('Effective public education')$info_lst

create_tb(m_info_lst, data, eff_pub_ed) 
...
create_tb_level2(m_info_lst, data, eff_pub_ed) 
...
```{r Student poverty concentration}
...
m_info_lst <- get_vars_info('Student poverty concentration')$info_lst

create_tb(m_info_lst, data, stu_poverty) 
...
create_tb_level2(m_info_lst, data, stu_poverty) 
...
m_info_lst <- get_vars_info('Employment')$info_lst

create_tb(m_info_lst, data, emp_lst) 
...
create_tb_level2(m_info_lst, data, emp_lst) 
