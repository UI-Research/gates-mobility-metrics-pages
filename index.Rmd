...
params:
  state_county: !r c('42051', '42095', '42017', '48453', '09003')
  fake_labels: FALSE
---
...
env_quality_poverty <- glue('{subdir}/enviromental-exposure_poverty.csv')
env_quality_race <- glue('{subdir}/enviromental-exposure_rae-ethnicity.csv')
...
data_w_subgroups <- bind_rows(list(race_ethnicity=read_csv(fpath_race_ethnicity, col_types = my_col_type), 
                                   race_ethnicity=read_csv(env_quality_race, col_types = my_col_type),
                                   race = read_csv(fpath_race, col_types = my_col_type), 
                                   race = read_csv(poverty_race, col_types = my_col_type), 
...
data <- bind_rows(list(`0` = data_not_multi_year, 
                       `1` = read_csv(fpath_multi_year, col_types = my_col_type, guess_max = 10000)), 
                  .id = 'is_year')
...
create_tb_multi_yr(income_m_info_lst, data_sub, income_varlist)
...
create_tb_level3(metrics_info_df = m_info_lst, 
                 dataset = data %>% filter(subgroup != 'Mixed Race and Ethnicity'), 
                 varname_maps = debt_varlist) 
...
create_tb_level2_homeless <- function(metrics_info_df, dataset, varname_maps){
  ...
  notes <- paste(notes, 
                 'The Confidence Interval for Share Homeless is not applicable.',
                 sep = '\n\n')
...
create_tb_multi_yr(metrics_info_df = fss_m_info_lst, 
                 dataset = data, 
                 varname_maps = famstruc_varlist) 
...
create_tb_multi_yr(metrics_info_df = nh_m_info_lst, 
                   dataset = data, 
                   varname_maps = neonatal_varlist) 
...
create_tb_multi_yr(metrics_info_df = et_m_info_lst, 
                   dataset = data, 
                   varname_maps = election_turnout_varlist) 
...
create_tb_multi_yr(metrics_info_df = ei_m_info_lst, 
                 dataset = data, 
                 varname_maps = econ_inc_varlist) 
...
create_tb_multi_yr(metrics_info_df = rd_m_info_lst, 
                   dataset = data, 
                   varname_maps = race_div) 
...
create_tb_multi_yr(metrics_info_df = trans_info_lst, 
                   dataset = data, 
                   varname_maps = trans_access) 
...
create_tb_multi_yr(metrics_info_df = tr_cost_m_info_lst, 
                 dataset = data, 
                 varname_maps = trans_cost_varlist) 
...
create_tb_level3(metrics_info_df = env_m_info_lst, 
                 dataset = data, 
                 varname_maps = env_varlist) 
...
create_tb_multi_yr(metrics_info_df = env_m_info_lst, 
                 dataset = data, 
                 varname_maps = env_varlist) 
...
create_tb_level3(metrics_info_df = epd_m_info_lst, 
                 dataset = data %>% filter(subgroup != 'Other Races and Ethnicities'), 
                 varname_maps = eff_pub_ed) 
...
create_tb_multi_yr(metrics_info_df = epd_m_info_lst, 
                   dataset = data, 
                   varname_maps = eff_pub_ed) 
...
create_tb_multi_yr(metrics_info_df = spoverty_m_info_lst, 
                 dataset = data, 
                 varname_maps = stu_poverty) 
...
create_tb_multi_yr(metrics_info_df = emp_m_info_lst, 
                 dataset = data, 
                 varname_maps = emp_lst) 
