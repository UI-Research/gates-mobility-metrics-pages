...
identifying_vars <- c('subgroup_id', 'state', 'county', 'state_name', 'county_name', 'population', 'subgroup_type', 'subgroup')
...
data <- bind_rows(data_w_subgroups, data_no_subgroups_clean)
