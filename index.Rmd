...
params:
  state_county: !r c('48303', '51760', '32003', '31055')
  fake_labels: TRUE
---
...
data <- data %>% 
  ...
  mutate_if(is.numeric, function(x) {format(round(x, 1), big.mark=",",scientific=FALSE)}) %>% 
...
*Visit [here](description.html#domain-financial-well-being) for a thorough description of the metrics in this domain.*


#### Predictor: Income {.tabset}
...
#### Predictor: Financial security {.tabset}
...
### Domain: Secure and Stable Housing

*Visit [here](description.html#domain-housing) for a thorough description of the metrics in this domain.*

#### Predictor: Affordable housing {.tabset}
...
#### Predictor: Housing instability and homelessness {.tabset}
...
create_tb_level2_homeless <- function(metrics_info_df, dataset, varname_maps){
  ...
  # add CI+ to 
  temp <- temp %>% 
    mutate(homeless_share_ci = '') 
    
  ci_str <- 'Confidence Interval+'
  
  col_to <- append(col_to, 'homeless_share_ci')
...
### Domain: Family Stability

*Visit [here](description.html#domain-family-stability) for a thorough description of the metrics in this domain.*

#### Predictor: Family structure and stability {.tabset}
...
*Visit [here](description.html#domain-health) for a thorough description of the metrics in this domain.*

#### Predictor: Access to and utilization of health services {.tabset}
...
#### Predictor: Neonatal health {.tabset}
...
*Visit [here](description.html#domain-local-governance) for a thorough description of the metrics in this domain.*

#### Predictor: Political participation {.tabset}
...
*Visit [here](description.html#domain-neighborhoods) for a thorough description of the metrics in this domain.*

#### Predictor: Economic inclusion {.tabset}
...
#### Predictor: Racial diversity {.tabset}
...
#### Predictor: Transportation access {.tabset}
...
#### Predictor: Environmental quality {.tabset}
...
*Visit [here](description.html#domain-safety) for a thorough description of the metrics in this domain.*

#### Predictor: Exposure to crime {.tabset}
...
#### Predictor: Overly punitive policing {.tabset}
...
*Visit [here](description.html#domain-education) for a thorough description of the metrics in this domain.*

#### Predictor: Access to preschool {.tabset}
...
#### Predictor: Effective public education {.tabset}
...
#### Predictor: Student poverty concentration {.tabset}
...
#### Predictor: College readiness {.tabset}
...
*Visit [here](description.html#domain-work) for a thorough description of the metrics in this domain.*

#### Predictor: Employment {.tabset}
...
#### Predictor: Access to jobs paying a living wage {.tabset}
