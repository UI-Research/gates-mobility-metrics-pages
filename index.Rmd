...
params:
  state_county: !r c('39035', '42095', '42017', '48453', '09003')
  fake_labels: FALSE
---
...
test <- read_csv(fpath_multi_year, guess_max = 10000)
...
create_tb_multi_yr_homeless(metrics_info_df = m_info_lst, 
                   dataset = data %>% filter(year %in% c('2,018', '2,014')), 
                   varname_maps = housing_insta_varlist) 
...
create_tb_multi_yr(metrics_info_df = ec_m_info_lst, 
                 dataset = data_sub_exp_crime %>% filter(year %in% c('2,015', '2,017')),
                 varname_maps = exp_crime_varlist)
...
create_tb_multi_yr(metrics_info_df = ap_m_info_lst, 
                 dataset = data, 
                 varname_maps = share_in_presch_varlist) 
