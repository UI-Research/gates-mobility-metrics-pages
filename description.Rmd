...
##### PREDICTOR: [INCOME](https://upward-mobility.urban.org/opportunities-income)
...
##### [PREDICTOR: AFFORDABLE HOUSING](https://upward-mobility.urban.org/housing-affordability) 
...
##### [PREDICTOR: HOUSING INSTABILITY AND HOMELESSNESS ](https://upward-mobility.urban.org/housing-stability)
...
##### [PREDICTOR: FAMILY STRUCTURE AND STABILITY](https://upward-mobility.urban.org/family-stability)
...
##### [PREDICTOR: OVERALL HEALTH](https://upward-mobility.urban.org/overall-health)
...
##### [PREDICTOR: ACCESS TO AND UTILIZATION OF HEALTH SERVICES](https://upward-mobility.urban.org/access-health-services)
...
##### [PREDICTOR: DESCRIPTIVE REPRESENTATION AMONG LOCAL OFFICIALS](https://upward-mobility.urban.org/descriptive-representation)
...
##### [PREDICTOR: BELONGINGNESS](https://upward-mobility.urban.org/belongingness)
...
##### [PREDICTOR: EXPOSURE TO TRAUMA](https://upward-mobility.urban.org/safety-trauma)
...
##### [PREDICTOR: EXPOSURE TO CRIME](https://upward-mobility.urban.org/safety-crime)
...
##### [PREDICTOR: EXPOSURE TO OVERLY PUNITIVE POLICING](https://upward-mobility.urban.org/just-policing)
...
##### [PREDICTOR: STUDENT POVERTY CONCENTRATION](https://upward-mobility.urban.org/school-economic-diversity)
...
##### [PREDICTOR: COLLEGE READINESS](https://upward-mobility.urban.org/preparation-college)
...
##### [PREDICTOR: ACCESS TO JOBS PAYING A LIVING WAGE](https://upward-mobility.urban.org/access-jobs-paying-living-wage)
