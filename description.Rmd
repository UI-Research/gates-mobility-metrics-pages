...
**Frequency:** Survey data are collected annually and used to create 1- and 5-year estimates for all jurisdictions in the county. Census data is collected every 10 years through the US Census. For subgroup analyses for less populated areas, it may be necessary to pool several years of data to obtain reliable estimates.
...
**Availability:** These ratios can be constructed using data from the Merican Community Survey (ACS) and income categories defined by the US Department of Housing and Urban Development, both of which are publicly available nationwide.
...
**Availability:** Data on living arrangements are available annually from the Census Bureau’s American Community Survey (ASC).
...
This metric shows what a “typical” job pays relative to the cost of living in a particular area. The metric is computed by dividing the average earnings from the median job in an area by the cost of meeting a family of three’s basic expenses in that area. 
