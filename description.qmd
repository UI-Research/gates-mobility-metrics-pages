...
##### PREDICTOR: [INCOME](https://upward-mobility.urban.org/opportunities-income){#sec-income}
...
##### PREDICTOR: [FINANCIAL SECURITY](https://upward-mobility.urban.org/financial-security-and-wealth-building-opportunities){#sec-financial-security}
...
##### PREDICTOR: [AFFORDABLE HOUSING](https://upward-mobility.urban.org/housing-affordability){#sec-affordable-housing} 
...
##### [PREDICTOR: HOUSING INSTABILITY AND HOMELESSNESS ](https://upward-mobility.urban.org/housing-stability){#sec-homelessness}
...
##### PREDICTOR: [FAMILY STRUCTURE AND STABILITY](https://upward-mobility.urban.org/family-stability){#sec-family-structure}
...
##### PREDICTOR: [OVERALL HEALTH](https://upward-mobility.urban.org/overall-health){#sec-overall-health}
...
##### PREDICTOR: [ACCESS TO AND UTILIZATION OF HEALTH SERVICES](https://upward-mobility.urban.org/access-health-services){#sec-access-to-health}
...
##### PREDICTOR: [NEONATAL HEALTH](https://upward-mobility.urban.org/neonatal-health){#sec-neonatal-health}
...
##### PREDICTOR: [POLITICAL PARTICIPATION](https://upward-mobility.urban.org/political-participation){#sec-political-participation}
...
##### PREDICTOR: [DESCRIPTIVE REPRESENTATION AMONG LOCAL OFFICIALS](https://upward-mobility.urban.org/descriptive-representation){#sec-descriptive-representation}
...
##### PREDICTOR: [ECONOMIC INCLUSION](https://upward-mobility.urban.org/economic-inclusion){#sec-economic-inclusion}
...
##### [PREDICTOR: RACIAL DIVERSITY](https://upward-mobility.urban.org/racial-diversity){#sec-racial-diversity}
...
##### [PREDICTOR: BELONGINGNESS](https://upward-mobility.urban.org/belongingness){#sec-belongingness}
...
##### [PREDICTOR: SOCIAL CAPITAL](https://upward-mobility.urban.org/social-capital){#sec-social-capital}
...
##### [PREDICTOR: TRANSPORTATION ACCESS](https://upward-mobility.urban.org/transportation-access){#sec-transportation-access}
...
##### [PREDICTOR: ENVIRONMENTAL QUALITY](https://upward-mobility.urban.org/environmental-quality){#sec-environmental-quality}
...
##### PREDICTOR: [EXPOSURE TO TRAUMA](https://upward-mobility.urban.org/safety-trauma){#sec-exposure-to-trauma}
...
##### PREDICTOR: [EXPOSURE TO CRIME](https://upward-mobility.urban.org/safety-crime){#sec-exposure-to-crime}
...
##### PREDICTOR: [EXPOSURE TO OVERLY PUNITIVE POLICING](https://upward-mobility.urban.org/just-policing){#sec-punitive-policing}
...
##### PREDICTOR: [ACCESS TO PRESCHOOL](https://upward-mobility.urban.org/access-preschool){#sec-preschool}
...
##### [PREDICTOR: EFFECTIVE PUBLIC EDUCATION](https://upward-mobility.urban.org/effective-public-education){#sec-public-education}
...
##### [PREDICTOR: STUDENT POVERTY CONCENTRATION](https://upward-mobility.urban.org/school-economic-diversity){#sec-poverty-concentration}
...
##### [PREDICTOR: COLLEGE READINESS](https://upward-mobility.urban.org/preparation-college){#sec-college-readiness}
...
##### [PREDICTOR: EMPLOYMENT](https://upward-mobility.urban.org/employment-opportunities){#sec-employment}
...
##### PREDICTOR: [ACCESS TO JOBS PAYING A LIVING WAGE](https://upward-mobility.urban.org/access-jobs-paying-living-wage){#sec-job-living-wage}
