...
This metric is constructed separately for each racial or ethnic group that is readily available and reliable, and reports the share of each group’s neighbors who are members of other racial or ethnic groups. The exposure index reflects the racial and ethnic diversity of neighborhoods. For example, the exposure index would report the share of people who are Hispanic; other races and ethnicities; and white, non-Hispanic in the census tract of the average Black, non-Hispanic person. Higher values of the index indicate more neighborhood diversity and more day-to-day exposure of people to neighbors of different races and ethnicities. 
...
**Availability:** The metric can be constructed using the CBP data set, which is publicly available nationwide. 
...
**Frequency:** This metric can be updated annually. Juvenile arrests data is available annually through the FBI. Arrest data before 2014 can be found on the Bureau of Justice Statistics Arrest Data tool.
