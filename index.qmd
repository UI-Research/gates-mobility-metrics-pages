---
title: 'Updward Mobility from Poverty Region Fact Sheet'
author: ''
date: ''
font: Lato
output:
...
rent_varlist <- list(
  ...
  c(
    "Share burdened for low-income households", 
    "Share burdened for very low-income households",
    "Share burdened for extremely low-income households"
  ), 
  c(
    "share_burdened_80_ami", 
    "share_burdened_80_ami_ci", 
    "share_burdened_50_ami",
    "share_burdened_50_ami_ci",
    "share_burdened_30_ami",
    "share_burdened_30_ami_ci"
  ), 
  c("Share burdened for low-income households", 
    "Share burdened for low-income households_ci", 
    "Share burdened for very low-income households", 
    "Share burdened for very low-income households_ci",
    "Share burdened for extremely low-income households", 
    "Share burdened for extremely low-income households_ci" 
  )
)

rb_m_info_lst <- get_vars_info("Rent burden", data_summary_file = m_info)$info_lst


create_tb(metrics_info_df = rb_m_info_lst, 
          dataset = data, 
          varname_maps = rent_varlist) 
```


##### Detail

```{r rent-burden-table2}
create_tb_level2(metrics_info_df = rb_m_info_lst, 
                 dataset = data, 
                 varname_maps = rent_varlist) 
...
create_tb_multi_yr(metrics_info_df = rb_m_info_lst, 
                   dataset = data, 
                   varname_maps = rent_varlist) 
...
<div class="exclude">*Visit [here](https://upward-mobility.urban.org/housing-affordability) for a thorough description of research surrounding this metric.*</div>

<br>


#### Predictor: Housing stability {.tabset .avoidpagebreak}
...
<div class="exclude">*Visit [here](https://upward-mobility.urban.org/housing-stability) for a thorough description of research surrounding this metric.*</div>
...
<div class="exclude">*Visit [here](https://upward-mobility.urban.org/economic-inclusion) for a thorough description of research surrounding this metric.*</div>
...
<div class="exclude">*Visit [here](https://upward-mobility.urban.org/racial-diversity) for a thorough description of research surrounding this metric.*</div>
...
<div class="exclude">*Visit [here](https://upward-mobility.urban.org/social-capital) for a thorough description of research surrounding this metric.*</div>
...
<div class="exclude">*Visit [here](https://upward-mobility.urban.org/transportation-access) for a thorough description of research surrounding this metric.*</div>
...
#### Predictor: Transportation cost {.tabset .avoidpagebreak}
...
<div class="exclude">*Visit [here](https://upward-mobility.urban.org/access-preschool) for a thorough description of research surrounding this metric.*</div>
...
<div class="exclude">*Visit [here](https://upward-mobility.urban.org/effective-public-education) for a thorough description of research surrounding this metric.*</div>
<br>


#### Predictor: School economic diversity {.tabset .avoidpagebreak}
...
<div class="exclude">*Visit [here](https://upward-mobility.urban.org/school-economic-diversity) for a thorough description of research surrounding this metric.*</div>

<br>

#### Predictor: Preparation for college {.tabset .avoidpagebreak}
...
<div class="exclude">*Visit [here](https://upward-mobility.urban.org/preparation-college) for a thorough description of research surrounding this metric.*</div>

<br>


#### Predictor: Digital access {.tabset .avoidpagebreak}

<!-- TO BE FILLED IN LATER -->

<div class="exclude">*Visit [here](https://upward-mobility.urban.org/digital-access) for a thorough description of research surrounding this metric.*</div>

<br>

## Pillar: Rewarding Work
#### Predictor: Employment Opportunities {.tabset .avoidpagebreak}
...
<div class="exclude">*Visit [here](https://upward-mobility.urban.org/employment-opportunities) for a thorough description of research surrounding this metric.*</div>
...
<div class="exclude">*Visit [here](https://upward-mobility.urban.org/access-jobs-paying-living-wage) for a thorough description of research surrounding this metric.*</div>


<br><br>


#### Predictor: Opportunities for Income {.tabset .avoidpagebreak}
##### Summary
...
<div class="exclude">*Visit [here](https://upward-mobility.urban.org/opportunities-income) for a thorough description of research surrounding this metric.*</div>
...
<div class="exclude">*Visit [here](https://upward-mobility.urban.org/financial-security-and-wealth-building-opportunities) for a thorough description of research surrounding this metric.*</div>


<br>


#### Predictor: Wealth-Building Opportunities {.tabset .avoidpagebreak}

<!-- TO BE FILLED IN LATER -->


<!-- <div class="exclude">*Visit here (currently missing) for a thorough description of research surrounding this metric.*</div> -->
...
#### Predictor: Access to health services {.tabset .avoidpagebreak}
...
<div class="exclude">*Visit [here](https://upward-mobility.urban.org/access-health-services) for a thorough description of research surrounding this metric.*</div>
...
<div class="exclude">*Visit [here](https://upward-mobility.urban.org/neonatal-health) for a thorough description of research surrounding this metric.*</div>
...
<div class="exclude">*Visit [here](https://upward-mobility.urban.org/environmental-quality) for a thorough description of research surrounding this metric.*</div>

<br>


#### Predictor: Safety from Trauma {.tabset .avoidpagebreak}

<!-- TO BE FILLED OUT LATER -->


<div class="exclude">*Visit [here](https://upward-mobility.urban.org/safety-trauma) for a thorough description of research surrounding this metric.*</div>
...
<div class="exclude">*Visit [here](https://upward-mobility.urban.org/political-participation) for a thorough description of research surrounding this metric.*</div>
...
<div class="exclude">*Visit [here](https://upward-mobility.urban.org/descriptive-representation) for a thorough description of research surrounding this metric.*</div>

<br>


#### Predictor: Safety from Crime {.tabset .avoidpagebreak}
...
<div class="exclude">*Visit [here](https://upward-mobility.urban.org/safety-crime) for a thorough description of research surrounding this metric.*</div>
...
<!-- NEED TO INCLUDE METRIC ON RATE OR REPORTED VIOLENT CRIME PER 100K -->
#### Predictor: Just policing {.tabset .avoidpagebreak}



<div class="exclude">*Visit [here](https://upward-mobility.urban.org/just-policing) for a thorough description of research surrounding this metric.*</div>
