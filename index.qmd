...
create_tb_level2(data = data_recent, 
                 metrics_info_df = af_m_info_lst, 
                 varname_maps = housing_varlist) 
```
...
create_tb(data = data_recent, 
          metrics_info_df = trans_info_lst, 
...
data_race_share %>%
  ...
  create_tb_more_data(metrics_info_df = trans_info_lst, 
                      varname_maps = trans_access)
...
create_tb(data = data_recent, 
          metrics_info_df = tr_cost_m_info_lst, 
...
data_race_share %>%
  ...
  create_tb_more_data(metrics_info_df = tr_cost_m_info_lst, 
                      varname_maps = trans_cost_varlist)
...
create_tb(data = data_recent, 
          metrics_info_df = epd_m_info_lst, 
...
create_tb(data = data_recent, 
          metrics_info_df = spoverty_m_info_lst, 
...
create_tb(data = data_recent, 
          metrics_info_df = emp_m_info_lst, 
...
create_tb(data = data_recent, 
          metrics_info_df = income_m_info_lst, 
...
```{r income-table2}
create_tb_more_data(data = date_race_ethnicity,
                    metrics_info_df = income_m_info_lst,
                    varname_maps = income_varlist)
...
data_race_share %>%
  ...
  create_tb_more_data(metrics_info_df = m_info_lst, 
                      varname_maps = debt_varlist) 
...
create_tb(data = data_recent, 
          metrics_info_df = env_m_info_lst, 
